      ...
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <div class="text-[11px] text-gray-500 dark:text-gray-400 flex items-center gap-3 mt-0.5 flex-wrap">
              <span>
        ...
        <span class="px-2.5 py-1 rounded-lg text-[11px] font-semibold bg-primary/10 text-primary border border-primary/20">
          ...
          >
            <div class="flex items-start justify-between gap-3">
              <div class="space-y-1.5 flex-1 min-w-0">
                ...
                <!-- Specs row -->
                <div class="flex items-center gap-3 pt-0.5 text-[11px] text-gray-500 dark:text-gray-400 flex-wrap">
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <span class="text-[11px] text-gray-400">
            Avtomatik dars soatlari taqsimlanadi
          </span>
        </div>
        ...
        <div class="text-[11px] text-gray-500 dark:text-gray-400 pt-1 border-t border-gray-200 dark:border-gray-800 flex items-center gap-1.5">
          <Icon icon="solar:info-circle-linear" class="text-xs text-primary shrink-0" />
          <span>
            Sinf rahbari asosiy fanlarga, ixtisoslashtirilgan fanlar esa mos fan o'qituvchilari va xonalariga (IT-Lab, Fizika, Kimyo, Sport) taqsimlanadi.
          </span>
        </div>
      </div>
    ...
    <template #footer="{ close }">
      <div class="flex items-center justify-between gap-3 w-full flex-wrap">
        <span class="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1.5">
          ...
          Darslar {{ activeQuarter?.name || '1-Chorak' }}ning barcha {{ weeksCount || 10 }} haftalik matritsasiga to'liq joylashtiriladi
        </span>
...
import { SCHEDULE_TEMPLATES, applyTemplateToDatedSchedule } from "@/api/scheduleData";
...
export default {
  ...
  methods: {
    ...
    applyTemplate() {
      ...
      const generated = applyTemplateToDatedSchedule(
        this.targetClass.id,
      ...
      if (this.options.navigateToClass && this.$route.path !== `/education/schedule/class/${this.targetClass.id}`) {
