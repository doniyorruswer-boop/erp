<template>
  <Teleport to="body">
    <Transition name="fade">
      ...
      >
        <div
          class="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full p-5 sm:p-6 border border-gray-200 dark:border-gray-700 shadow-2xl animate-scale-up"
        >
          <div class="flex items-start gap-3.5">
            ...
            <div
              ...
              :class="
                isDanger
                  ? 'bg-red-50 text-red-600 dark:bg-red-950/40 border border-red-200 dark:border-red-800'
                  : 'bg-primary/10 text-primary border border-primary/20'
              "
            >
              <Icon
                :icon="isDanger ? 'solar:trash-bin-trash-bold' : 'solar:info-circle-bold'"
                class="text-2xl"
              />
            </div>
            ...
            <div class="flex-1 min-w-0">
              ...
              <p
                class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1.5 leading-relaxed break-words"
              >
                {{ message }}
              </p>
            </div>
          ...
          <!-- Buttons -->
          <div
            class="flex items-center justify-end gap-2.5 mt-6 pt-3 border-t border-gray-100 dark:border-gray-700"
          >
            <button
              type="button"
