<template>
  <div
    class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 sm:p-4.5 shadow-2xs space-y-3.5"
  >
    ...
    <div>
      ...
      <p
        class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1.5 flex items-center flex-wrap gap-x-3 gap-y-1"
      >
        <span class="font-medium text-gray-700 dark:text-gray-300"
          >{{ classInfo.academicYear }} o'quv yili</span
        >
        <span>•</span>
        <span class="font-medium text-gray-700 dark:text-gray-300"
          >{{ studentCount }} ta
          {{ tenantStore.isKindergarten ? "tarbiyalanuvchi" : "o'quvchi" }}</span
        >
        <span>•</span>
        <span class="flex items-center gap-1.5">
          ...
          <strong class="text-gray-900 dark:text-gray-100 font-semibold">{{
            classInfo.teacherName || "Belgilanmagan"
          }}</strong>
        </span>
      </p>
    </div>
    ...
    <div class="flex items-center gap-2 border-b border-gray-200 dark:border-gray-700 pt-1">
      ...
      >
        ...
        <span>{{
          tenantStore.isKindergarten ? "Kun tartibi & Mashg'ulotlar" : "Dars jadvali & Tarix"
        }}</span>
      </button>
    </div>
  </div>
