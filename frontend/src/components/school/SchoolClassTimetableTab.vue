<template>
  <div class="space-y-5">
    <div
      class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-5 sm:p-6 shadow-xs space-y-4"
    >
      <div class="flex items-center justify-between flex-wrap gap-2">
        <div>
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">
            1-smena: 08:00 dan 12:10 gacha bo'lgan dars soatlari
          </p>
        </div>
        <button
          type="button"
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-3.5 text-sm">
        ...
        >
          <div
            class="font-bold text-gray-800 dark:text-gray-200 border-b pb-2 dark:border-gray-700 flex items-center justify-between"
          >
            <span>{{ day.name }}</span>
          ...
          <div class="space-y-2">
            ...
            >
              <div class="font-bold text-gray-800 dark:text-gray-200 text-xs sm:text-sm truncate">
                {{ ls.subject }}
              </div>
