<template>
  <div class="inline-flex items-center gap-1.5 text-xs text-gray-700 dark:text-gray-300 whitespace-nowrap select-none group">
    ...
    <button
      ...
      :title="title"
    >
      <Icon :icon="copied ? 'solar:check-circle-bold' : 'solar:copy-linear'" :class="copied ? 'text-emerald-500' : ''" class="text-xs" />
    </button>
  </div>
</template>
