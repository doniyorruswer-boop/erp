<template>
  <div class="monthly-contracts-statistics font-lexend space-y-3">
    ...
    <div
      class="card bg-white dark:bg-gray-800 rounded-2xl border dark:border-gray-700 shadow-xs overflow-hidden"
    >
      <div class="overflow-x-auto">
        <table class="w-full text-xs text-left border-collapse">
          <thead>
            <tr
              class="bg-gray-50/80 dark:bg-gray-700/60 text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider text-[11px] border-b dark:border-gray-700"
            >
          ...
          <tbody class="divide-y divide-gray-100 dark:divide-gray-700/60 font-medium">
            ...
            >
              ...
              <td
                class="py-3 px-3 text-indigo-600 dark:text-indigo-400 font-bold whitespace-nowrap"
              >
                <span class="flex items-center gap-1.5">
              ...
              <!-- 6. TO'LOV (Yashil) -->
              <td
                class="py-3 px-3 text-emerald-600 dark:text-emerald-400 font-bold whitespace-nowrap"
              >
                <span class="flex items-center gap-1.5">
              ...
              <td class="py-3 px-4 min-w-[130px]">
                <div class="flex items-center gap-2">
                  <div
                    class="flex-1 bg-gray-100 dark:bg-gray-700 h-1.5 rounded-full overflow-hidden"
                  >
                    <div
                  ...
                  <span
                    class="text-[11px] font-bold text-gray-700 dark:text-gray-200 w-9 text-right"
                  >
                    {{ row.percentage }}%
                  </span>
                </div>
          ...
          <tfoot>
            <tr
              class="bg-gray-50 dark:bg-gray-700/80 font-bold text-xs border-t-2 border-gray-200 dark:border-gray-700"
            >
              <td class="py-3.5 px-4 text-gray-900 dark:text-white uppercase">Jami</td>
