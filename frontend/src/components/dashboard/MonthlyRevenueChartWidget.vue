<template>
  <div class="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-5 border border-gray-200 dark:border-gray-700 shadow-2xs space-y-4 font-lexend">
    ...
    <div class="relative pt-2">
      ...
      <div class="absolute inset-x-0 top-2 bottom-8 flex flex-col justify-between pointer-events-none">
        <div v-for="(level, idx) in yLevels" :key="idx" class="flex items-center gap-2 w-full text-xs font-medium text-gray-400">
      ...
      <div class="pl-16 pr-3 h-52 flex items-end justify-between gap-1.5 sm:gap-3 relative z-10">
        ...
        >
          ...
          >
            <div class="font-bold text-amber-400 border-b border-gray-700/80 pb-1 mb-1.5 flex items-center justify-between">
          ...
          <!-- Double Bar Pair -->
          <div class="w-full flex items-end justify-center gap-1 h-40 bg-gray-50/70 dark:bg-gray-700/20 rounded-md p-1 group-hover:bg-gray-100/80 dark:group-hover:bg-gray-700/40 transition">
    ...
    <!-- Bottom Legend -->
    <div class="flex items-center justify-center gap-5 pt-3 border-t border-gray-100 dark:border-gray-700/60 text-xs sm:text-sm font-medium flex-wrap">
...
export default {
  ...
  props: {
    ...
    monthlyData: {
      type: Array,
      default: () => [
        { month: "Avg", fullMonth: "Avgust", expected: 59700400, collected: 4700000, debtors: 4, isCurrent: false },
        { month: "Sen", fullMonth: "Sentabr", expected: 1523280400, collected: 1242116000, debtors: 85, isCurrent: false },
        { month: "Okt", fullMonth: "Oktabr", expected: 1619165400, collected: 1301618000, debtors: 120, isCurrent: true },
        { month: "Noy", fullMonth: "Noyabr", expected: 1678855400, collected: 1366619000, debtors: 162, isCurrent: false },
        { month: "Dek", fullMonth: "Dekabr", expected: 1766745400, collected: 1370003000, debtors: 110, isCurrent: false },
        { month: "Yan", fullMonth: "Yanvar", expected: 1835835400, collected: 1450561000, debtors: 130, isCurrent: false },
        { month: "Fev", fullMonth: "Fevral", expected: 1927720400, collected: 1503483000, debtors: 140, isCurrent: false },
        { month: "Mar", fullMonth: "Mart", expected: 2015610400, collected: 1627093000, debtors: 125, isCurrent: false },
        { month: "Apr", fullMonth: "Aprel", expected: 2102795400, collected: 1640488000, debtors: 115, isCurrent: false },
        { month: "May", fullMonth: "May", expected: 2204785400, collected: 1687741000, debtors: 95, isCurrent: false },
      ],
    },
  },
  data() {
