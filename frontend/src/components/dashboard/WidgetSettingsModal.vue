  ...
  >
    ...
    <template #body>
      <div class="space-y-4 font-lexend">
        ...
        <div class="p-3 rounded-md bg-gray-50 dark:bg-gray-700/40 border border-gray-200 dark:border-gray-700 space-y-2">
          <div class="flex items-center justify-between">
            <span class="text-xs font-semibold uppercase tracking-wider text-gray-700 dark:text-gray-300 flex items-center gap-1.5">
        ...
        <div class="space-y-3.5 max-h-[50vh] overflow-y-auto pr-1">
          <div
            v-for="group in categorizedWidgets"
            :key="group.title"
            class="space-y-1.5"
          >
            <!-- Category Title Header -->
            <div class="flex items-center gap-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider pt-2 border-t border-gray-100 dark:border-gray-700/60 first:border-0 first:pt-0">
              <Icon :icon="group.icon" class="text-primary text-sm" />
              <span>{{ group.title }}</span>
            </div>

            <!-- Widget Items in Group (rounded-md) -->
            <div class="divide-y divide-gray-100 dark:divide-gray-700/50 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
              <div
              ...
              >
                ...
                <div class="flex items-center shrink-0" @click.stop>
                  ...
                  <button
                    ...
                    :title="localSettings[w.key] ? 'O\'chirish uchun bosing' : 'Yoqish uchun bosing'"
                  >
                    <span
