  ...
  <div class="financial-activity-section font-lexend space-y-3">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 items-center pt-1">
      ...
      <div class="lg:col-span-7 flex items-center justify-between">
        <h3
          class="text-sm sm:text-base font-bold text-gray-800 dark:text-gray-100 uppercase tracking-wider"
        >
          MOLIYAVIY TAHLIL
        </h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
      ...
      <div
        class="lg:col-span-7 card bg-white dark:bg-gray-800 p-5 rounded-2xl border dark:border-gray-700 shadow-xs flex flex-col justify-between"
      >
        <div>
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 mb-3">
            ...
            <div class="flex items-center gap-3">
              ...
              <div
                class="flex items-center bg-gray-100 dark:bg-gray-700/60 p-0.5 rounded-lg border dark:border-gray-600 text-xs"
              >
                <button
                  type="button"
                  :class="[
        ...
        <div
          class="pt-2 border-t dark:border-gray-700/60 flex items-center justify-between text-xs text-gray-400"
        >
      ...
      <div
        class="lg:col-span-5 card bg-white dark:bg-gray-800 p-5 rounded-2xl border dark:border-gray-700 shadow-xs flex flex-col justify-between"
      >
        <div>
          <!-- Tab Navigation with Primary Setup Theme Colors -->
          <div
            class="flex items-center gap-1.5 sm:gap-2 pb-3 border-b dark:border-gray-700 overflow-x-auto"
          >
            ...
            >
              ...
              <span
                class="px-1.5 py-0.2 text-[10px] font-bold rounded-full bg-rose-100 dark:bg-rose-900/40 text-rose-600 dark:text-rose-300"
              >
                Top 5
              </span>
            </button>
            ...
            >
              ...
              <span
                class="px-1.5 py-0.2 text-[10px] font-bold rounded-full bg-primary/10 text-primary"
              >
                1 Bugun
              </span>
            </button>
          ...
          <!-- Table Header -->
          <div
            class="grid grid-cols-12 text-[11px] font-bold text-gray-400 dark:text-gray-400 py-2.5 uppercase tracking-wider border-b dark:border-gray-700/60"
          >
          ...
          <div v-if="activeTab === 'debtorStudents'">
            <div
              v-if="topDebtorStudents.length > 0"
            ...
            >
              ...
              >
                ...
                <div class="col-span-6 min-w-0 pr-2">
                  <p class="font-bold text-gray-800 dark:text-gray-100 truncate" :title="st.name">
                    {{ st.name }}
                  </p>
                ...
                <div
                  class="col-span-3 text-right font-bold text-rose-600 dark:text-rose-400 text-xs sm:text-sm"
                >
          ...
          <div v-else-if="activeTab === 'debtorClasses'">
            <div
              v-if="topDebtorClasses.length > 0"
              class="divide-y divide-gray-100 dark:divide-gray-700/60"
            >
              <div
          ...
          <div v-else-if="activeTab === 'recentPayments'">
            <div
              v-if="topRecentPayments.length > 0"
              class="divide-y divide-gray-100 dark:divide-gray-700/60"
            >
              <div
              ...
              >
                ...
                <div
                  class="col-span-3 text-right font-bold text-emerald-600 dark:text-emerald-400 text-xs sm:text-sm"
                >
        ...
        <!-- Right Box Footer -->
        <div
          class="pt-3 mt-2 border-t dark:border-gray-700/60 flex items-center justify-between text-xs"
        >
          <span class="text-gray-500 dark:text-gray-400">
            Jami <b class="text-rose-500 font-bold">{{ totalDebtorsCount }} ta</b> kritik qarzdor
            bor
          </span>
          <button
            type="button"
    ...
    >
      ...
      <div
        class="p-4 border-b dark:border-gray-700 bg-white dark:bg-gray-800 flex items-center justify-between flex-wrap gap-3"
      >
        <!-- Search -->
        <div class="relative w-full sm:w-72">
          <Icon
            icon="solar:magnifer-linear"
            class="absolute left-3 top-2.5 text-gray-400 text-base"
          />
          <input
            v-model="modalSearch"
            type="text"
      ...
      <div class="overflow-y-auto p-4 max-h-[60vh]">
        ...
        <table v-if="modalTab === 'debtors'" class="w-full text-left text-xs border-collapse">
          <thead>
            <tr
              class="bg-gray-50 dark:bg-gray-700/50 text-gray-500 dark:text-gray-300 font-semibold uppercase"
            >
              <th class="p-3">#</th>
          ...
          <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            >
              ...
              <td class="p-3 text-center">
                <span
                  class="px-2 py-0.5 rounded-full text-[11px] font-bold bg-rose-50 text-rose-600 dark:bg-rose-900/30"
                >
                  {{ st.days }} kun
                </span>
              </td>
        ...
        <table v-else class="w-full text-left text-xs border-collapse">
          ...
          <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            >
              ...
              <td class="p-3">
                <span
                  class="px-2 py-0.5 rounded text-[10px] font-bold bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300"
                >
                  {{ p.categoryLabel }}
                </span>
              </td>
      ...
      <template #footer="{ close }">
        <span class="text-xs text-gray-500">
          Ko'rsatilmoqda:
          <b>{{
            modalTab === "debtors" ? filteredModalDebtors.length : filteredModalPayments.length
          }}</b>
          ta yozuv
        </span>
        <button
...
import { CHART_COLORS, THEME_COLORS } from "@/constants/colors.constants";
...
export default {
  ...
  data() {
    return {
      ...
      themePrimaryColor: THEME_COLORS.SUCCESS,

      // Top 5 Debtor Students (Matches user screenshot)
      topDebtorStudents: [
        {
          id: 1,
          name: "Burxonov Otabek Suxrob o'g'li",
          className: "O'rta guruh sinf",
          days: 383,
          debtAmount: 68750000,
        ...
        {
          id: 2,
          name: "Sharipova Shahnoza Bekzod qizi",
          className: "Kichik sinf",
          days: 363,
          debtAmount: 36000000,
        ...
        {
          id: 3,
          name: "Nihil voluptas volup Nihil anim velit",
          className: "1-A sinf",
          days: 359,
          debtAmount: 35454545,
        ...
        {
          id: 4,
          name: "Jo'rayeva Yulduz Zohid qizi",
          className: "1-A sinf",
          days: 359,
          debtAmount: 35454545,
        ...
        {
          id: 5,
          name: "Rahmonov Dilshod Xudoyberdi o'g'li",
          className: "7-B sinf",
          days: 361,
          debtAmount: 33736667,
      ...
      topRecentPayments: [
        ...
        },
        {
          ...
          method: "Karta (Terminal)",
          amount: 400000,
          date: "Bugun 09:45",
        },
        {
          id: 4,
          studentName: "Laylo Sharipova",
          className: "2-A sinf",
          categoryLabel: "Ta'lim kontrakt",
          method: "Naqd pul",
          amount: 3200000,
      ...
      allDebtorsList: [
        ...
        {
          id: 6,
          name: "Karimov Anvar Botir o'g'li",
          className: "3-B sinf",
          days: 340,
          debtAmount: 28500000,
        ...
        {
          id: 7,
          name: "Toshmatova Zilola Akbar qizi",
          className: "5-A sinf",
          days: 320,
          debtAmount: 24200000,
        ...
        {
          id: 8,
          name: "Azizov Jamshid Farhod o'g'li",
          className: "2-A sinf",
          days: 310,
          debtAmount: 22000000,
        ...
        {
          id: 9,
          name: "Yusupova Malika Sanjar qizi",
          className: "6-A sinf",
          days: 295,
          debtAmount: 19500000,
        ...
        {
          id: 10,
          name: "Saidov Rustam Erkin o'g'li",
          className: "8-B sinf",
          days: 280,
          debtAmount: 17800000,
  ...
  computed: {
    areaChartOptions() {
      return {
        ...
        colors: [
          this.themePrimaryColor || THEME_COLORS.PRIMARY,
          THEME_COLORS.DANGER,
        ...
        xaxis: {
          ...
          labels: { style: { colors: CHART_COLORS.AXIS_LABEL, fontSize: "10px" } },
        },
        yaxis: {
          labels: {
            style: { colors: CHART_COLORS.AXIS_LABEL, fontSize: "10px" },
            formatter: (val) => `${val}m`,
          },
        },
        grid: {
    ...
    async fetchFinancialData() {
      try {
        ...
        if (stats) {
          ...
          if (
            stats.debtorStudents &&
            Array.isArray(stats.debtorStudents) &&
            stats.debtorStudents.length > 0
          ) {
