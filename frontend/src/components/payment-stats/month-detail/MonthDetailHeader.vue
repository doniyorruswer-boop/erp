<template>
  <div class="space-y-4">
    ...
    <!-- Header Section -->
    <div class="flex items-center justify-between flex-wrap gap-4 bg-white dark:bg-gray-800 p-4 sm:p-5 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-2xs">
      <div>
        <div class="flex items-center gap-3 flex-wrap">
          ...
          >
            {{ monthInfo.percent >= 80 ? "Reja a'lo darajada bajarildi" : monthInfo.percent >= 50 ? "O'rtacha bajarilish" : "To'lovlar yig'ilmoqda" }}
          </span>
        </div>
        <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
          Ushbu oy uchun kutilgan reja, faktik tushum, to'lov usullari taqsimoti va qarzdorlar tahlili
        </p>
      </div>
