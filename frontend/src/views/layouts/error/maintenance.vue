<template>
  <div class="container lg:max-w-7xl mx-auto text-center mt-40">
    <div class="space-y-8">
      <h1 class="text-9xl flex justify-center dark:text-white text-gray-800 font-bold">
      ...
      <p class="dark:text-gray-500 max-w-2xl mx-auto text-gray-800">
        Why is this happening?, Actually we are fixing bugs regularly and maintaining the server
        app, don't worry it won't take long.
      </p>
