<template>
  <div class="course-center-dashboard space-y-5">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
      <!-- Main Revenue Chart -->
      <div
        class="lg:col-span-2 card bg-white dark:bg-gray-800 p-5 rounded-xl border dark:border-gray-700 shadow-xs flex flex-col justify-between"
      >
        <div>
            ...
            <div>
              <div class="flex items-center gap-2">
                <span class="text-xs font-bold uppercase text-primary tracking-wider"
                  >MOLIYAVIY DINAMIKA</span
                >
                <span
                  class="px-2 py-0.5 text-[11px] font-bold bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300 rounded-full"
                >
                  +24.5% O'sish
                </span>
              </div>
        ...
        <div
          class="pt-3 border-t dark:border-gray-700/60 flex items-center justify-between flex-wrap gap-2 text-xs text-gray-500 dark:text-gray-400"
        >
      ...
      <div
        class="card bg-white dark:bg-gray-800 p-5 rounded-xl border dark:border-gray-700 shadow-xs flex flex-col justify-between"
      >
        <div>
          <div class="flex items-center justify-between mb-4 pb-2 border-b dark:border-gray-700">
            <div>
              <h3 class="font-bold text-gray-800 dark:text-gray-100 text-base">
                Top Mentorlar & O'qituvchilar
              </h3>
              <p class="text-xs text-gray-400">O'quvchilar soni va yuklama bo'yicha</p>
            </div>
            <span
              class="text-xs px-2 py-0.5 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 font-semibold"
            >
          ...
          <div v-if="topTeachers.length > 0" class="space-y-3">
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-[11px] text-gray-400">
                    {{ t.subject || "Asosiy Mentor" }} • {{ t.groupsCount || 1 }} ta guruh
                  </p>
                </div>
              </div>
              ...
              <div class="text-right">
                ...
                <div
                  class="text-[10px] text-green-600 font-medium flex items-center justify-end gap-1"
                >
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
      ...
      >
          ...
          <div class="flex items-center justify-between mb-3">
            <div>
              ...
              <h3 class="font-bold text-sm text-gray-800 dark:text-gray-100">
                Yangi vs Bitiruvchilar
              </h3>
            </div>
            <span
              class="text-xs font-bold text-green-600 bg-green-50 dark:bg-green-900/30 px-2 py-0.5 rounded-full"
            >
              +27.9% ↑
            </span>
          </div>
        ...
        >
          ...
          <RouterLink to="/students" class="text-primary font-medium hover:underline"
            >O'quvchilar ro'yxati</RouterLink
          >
        </div>
      </div>
      ...
      >
        <div>
          <div class="flex items-center justify-between mb-3">
            <div>
              <div class="text-xs font-bold text-purple-600 uppercase tracking-wide">
                SOTUV VORONKASI
              </div>
              <h3 class="font-bold text-sm text-gray-800 dark:text-gray-100">
                Haftalik Lidlar Oqimi
              </h3>
            </div>
            <span
              class="text-xs font-bold text-purple-600 bg-purple-50 dark:bg-purple-900/30 px-2 py-0.5 rounded-full"
            >
              +47.9% ↑
            </span>
          </div>
        ...
        >
          ...
          <RouterLink to="/leads" class="text-purple-600 font-medium hover:underline"
            >Voronka doskasi</RouterLink
          >
        </div>
      </div>
      ...
      >
        <div>
          <div class="flex items-center justify-between mb-3">
            <div>
              <div class="text-xs font-bold text-amber-500 uppercase tracking-wide">
                ULUSHLAR TAHLILI
              </div>
              <h3 class="font-bold text-sm text-gray-800 dark:text-gray-100">
            ...
            <span
              class="text-xs font-semibold text-gray-400 bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded"
            >
              Kassa
            </span>
          </div>
        ...
        >
          ...
          <RouterLink to="/finance" class="text-amber-500 font-medium hover:underline"
            >Moliya hisoboti</RouterLink
          >
        </div>
      </div>
    </div>
    ...
    <div
      class="card bg-white dark:bg-gray-800 p-5 rounded-xl border dark:border-gray-700 shadow-xs"
    >
      <div
        class="flex items-center justify-between flex-wrap gap-2 mb-4 pb-3 border-b dark:border-gray-700"
      >
        <div>
            ...
            >
              <td class="p-3 font-semibold text-gray-800 dark:text-gray-200">
                <div class="flex items-center gap-2.5">
                  <div
                    class="w-7 h-7 rounded-full bg-primary/10 text-primary font-bold flex items-center justify-center text-xs"
                  >
              ...
              <td class="p-3 text-center">
                <span
                  class="px-2 py-0.5 rounded-full text-[10px] font-bold bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300"
                >
                  Qabul qilindi
                </span>
              </td>
  ...
  computed: {
    ...
    revenueChartOptions() {
      ...
      return {
        ...
        colors: [...CHART_COLORS.REVENUE_EXPENSE],
        ...
        xaxis: {
          categories,
          labels: { style: { colors: CHART_COLORS.AXIS_LABEL, fontSize: "11px" } },
          axisBorder: { show: false },
        },
        yaxis: {
          labels: {
            style: { colors: CHART_COLORS.AXIS_LABEL, fontSize: "11px" },
    ...
    studentsFlowChartOptions() {
      return {
        ...
        colors: [...CHART_COLORS.TREND_COMPARISON],
        plotOptions: {
          bar: {
            horizontal: false,
            columnWidth: "50%",
        ...
        xaxis: {
          categories: this.stats.studentsFlow?.categories || [
            "Fev",
            "Mar",
            "Apr",
            "May",
    ...
    leadsGrowthChartOptions() {
      return {
        ...
        colors: [...CHART_COLORS.SINGLE_PURPLE],
        ...
        dataLabels: { enabled: false },
        xaxis: {
          categories: this.stats.leadsGrowth?.categories || [
            "Dush",
            "Sesh",
            "Chor",
            "Pay",
    ...
    distributionChartOptions() {
      return {
        ...
        colors: [...CHART_COLORS.MULTI_METRIC],
        labels:
          this.stats.paymentMethods?.labels ||
          DEFAULT_PAYMENT_METHODS.slice(0, 4).map((m) => m.name),
        dataLabels: { enabled: false },
        legend: {
          position: "bottom",
          fontSize: "11px",
          labels: { colors: CHART_COLORS.AXIS_LABEL_DARK },
        },
        plotOptions: {
          pie: {
            donut: {
