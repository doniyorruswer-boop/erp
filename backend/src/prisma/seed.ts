  ...
  for (const org of allOrgs) {
    if (!APPROVED_SLUGS.includes(org.slug)) {
      ...
      try {
        ...
        console.warn(`    Xatolik o'chirishda (${org.slug}):`, err.message);
      }
    }
  }
}
...
async function main() {
  ...
  console.log('🧹 Tasdiqlangan tashkilotlar ichidagi eski ma\'lumotlar toza holatga keltirilmoqda...');
  ...
  await prisma.systemConfig.upsert({
    ...
    update: {
      businessType: BusinessType.COURSE_CENTER,
      enabledModules: ['LEADS', 'STUDENTS', 'GROUPS', 'COURSES', 'ATTENDANCE', 'FINANCE', 'SMS', 'PAYMENTS', 'CONTRACTS'],
      features: { contracts: true, trialLessons: true, gradingSystem: false },
      terminology: { groupLabel: 'Guruh', courseLabel: 'Kurs', studentLabel: "O'quvchi", teacherLabel: 'Mentor' },
    },
    create: {
  ...
  const roomEdu102 = await prisma.room.create({
    data: { organizationId: orgEdu.id, branchId: branchEdu.id, name: '102 - Speaking Club', capacity: 16 },
  });
  const roomEdu201 = await prisma.room.create({
    data: { organizationId: orgEdu.id, branchId: branchEdu.id, name: '201 - Intensive Room', capacity: 20 },
  });
  ...
  const eduStudentsData = [
    { firstName: 'Shoxrux', lastName: 'Xalilov', phone: '+998901111001', grp: grpIelts.id, balance: 0, paid: 900000, fee: 900000 },
    { firstName: 'Diyorbek', lastName: 'Aliyev', phone: '+998901111002', grp: grpIelts.id, balance: -900000, paid: 0, fee: 900000 },
    { firstName: 'Kamila', lastName: 'Umarova', phone: '+998901111003', grp: grpIelts.id, balance: 0, paid: 900000, fee: 900000 },
    { firstName: 'Farrux', lastName: 'Toshpulatov', phone: '+998901111004', grp: grpFrontend.id, balance: 0, paid: 1300000, fee: 1300000 },
    { firstName: 'Sevara', lastName: 'Mahmudova', phone: '+998901111005', grp: grpFrontend.id, balance: -1300000, paid: 0, fee: 1300000 },
    { firstName: 'Bobur', lastName: 'Zokirov', phone: '+998901111006', grp: grpFrontend.id, balance: 0, paid: 1300000, fee: 1300000 },
    { firstName: 'Azizbek', lastName: 'Nurmatov', phone: '+998901111007', grp: grpFrontend.id, balance: 0, paid: 1300000, fee: 1300000 },
    { firstName: 'Nilufar', lastName: 'Qosimova', phone: '+998901111008', grp: grpPython.id, balance: 0, paid: 1300000, fee: 1300000 },
    { firstName: 'Rustam', lastName: 'Ibragimov', phone: '+998901111009', grp: grpPython.id, balance: -650000, paid: 650000, fee: 1300000 },
    { firstName: 'Laylo', lastName: 'Ergasheva', phone: '+998901111010', grp: grpPython.id, balance: 0, paid: 1300000, fee: 1300000 },
    { firstName: 'Timur', lastName: 'Ahmedov', phone: '+998901111011', grp: grpSat.id, balance: 0, paid: 850000, fee: 850000 },
    { firstName: 'Shahzoda', lastName: 'Yusupova', phone: '+998901111012', grp: grpSat.id, balance: -850000, paid: 0, fee: 850000 },
    { firstName: 'Javohir', lastName: 'Nematov', phone: '+998901111013', grp: grpSat.id, balance: 0, paid: 850000, fee: 850000 },
    { firstName: 'Madina', lastName: 'Karimova', phone: '+998901111014', grp: grpIelts.id, balance: 0, paid: 900000, fee: 900000 },
    { firstName: 'Asadbek', lastName: 'Mirzayev', phone: '+998901111015', grp: grpFrontend.id, balance: -1300000, paid: 0, fee: 1300000 },
  ];
  ...
  const eduLeads = [
    ...
    { name: 'Bekzod Qodirov', phone: '+998909001003', status: LeadStatus.CONTACTED, source: 'Tavsiya' },
    { name: 'Nodira Aliyeva', phone: '+998909001004', status: LeadStatus.CONTACTED, source: 'Instagram' },
    { name: 'Sardor Karimov', phone: '+998909001005', status: LeadStatus.TRIAL_BOOKED, source: 'Banner' },
    { name: 'Maftuna Vohidova', phone: '+998909001006', status: LeadStatus.TRIAL_BOOKED, source: 'Instagram' },
    { name: 'Jasur Mirzayev', phone: '+998909001007', status: LeadStatus.TRIAL_ATTENDED, source: 'Telegram' },
    { name: 'Guli Sharipova', phone: '+998909001008', status: LeadStatus.TRIAL_ATTENDED, source: 'Tavsiya' },
    { name: 'Anvar Ergashev', phone: '+998909001009', status: LeadStatus.ENROLLED, source: 'Instagram' },
    { name: 'Sabina Yunusova', phone: '+998909001010', status: LeadStatus.LOST, source: 'Banner', notes: 'Boshqa vaqt so\'radi' },
  ];
  ...
  await prisma.systemConfig.upsert({
    ...
    update: {
      businessType: BusinessType.SCHOOL,
      enabledModules: ['STUDENTS', 'CLASSES', 'CONTRACTS', 'ATTENDANCE', 'FINANCE', 'SERVICES', 'SMS'],
      features: { contracts: true, gradingSystem: true, canteenService: true, transportService: true },
      terminology: { groupLabel: 'Sinf', courseLabel: 'Fan', studentLabel: "O'quvchi", teacherLabel: "O'qituvchi" },
    },
    create: {
  ...
  const rSch101 = await prisma.room.create({
    data: { organizationId: orgSchool.id, branchId: branchSchool.id, name: '101 - 1-A Boshlang\'ich', capacity: 22 },
  });
  const rSch102 = await prisma.room.create({
    data: { organizationId: orgSchool.id, branchId: branchSchool.id, name: '102 - 2-A Boshlang\'ich', capacity: 22 },
  });
  const rSch201 = await prisma.room.create({
    data: { organizationId: orgSchool.id, branchId: branchSchool.id, name: '201 - 5-B Matematika', capacity: 24 },
  });
  const rSch202 = await prisma.room.create({
    data: { organizationId: orgSchool.id, branchId: branchSchool.id, name: '202 - 9-A Fizika Laboratoriya', capacity: 24 },
  });
  ...
  const schoolStudentsData = [
    { firstName: 'Jasur', lastName: 'Bekmurodov', phone: '+998902221001', grp: class1A.id, balance: 0, fee: 3200000, paid: 3200000 },
    { firstName: 'Madina', lastName: 'Aliyeva', phone: '+998902221002', grp: class1A.id, balance: -3200000, fee: 3200000, paid: 0 },
    { firstName: 'Sardor', lastName: 'Yusupov', phone: '+998902221003', grp: class1A.id, balance: 0, fee: 3200000, paid: 3200000 },
    { firstName: 'Laylo', lastName: 'Sharipova', phone: '+998902221004', grp: class2A.id, balance: -6400000, fee: 3200000, paid: 0 },
    { firstName: 'Bobur', lastName: 'Mirzayev', phone: '+998902221005', grp: class2A.id, balance: 0, fee: 3200000, paid: 3200000 },
    { firstName: 'Nilufar', lastName: 'Vohidova', phone: '+998902221006', grp: class5B.id, balance: -3600000, fee: 3600000, paid: 0 },
    { firstName: 'Davron', lastName: 'Qobilov', phone: '+998902221007', grp: class5B.id, balance: 0, fee: 3600000, paid: 3600000 },
    { firstName: 'Zilola', lastName: 'Toshmatova', phone: '+998902221008', grp: class5B.id, balance: -7200000, fee: 3600000, paid: 0 },
    { firstName: 'Anvar', lastName: 'Karimov', phone: '+998902221009', grp: class9A.id, balance: 0, fee: 3600000, paid: 3600000 },
    { firstName: 'Sarvar', lastName: 'To\'rayev', phone: '+998902221010', grp: class9A.id, balance: 0, fee: 3600000, paid: 3600000 },
    { firstName: 'Gulnoza', lastName: 'Rahimova', phone: '+998902221011', grp: class9A.id, balance: -3600000, fee: 3600000, paid: 0 },
    { firstName: 'Akmal', lastName: 'Fayzullayev', phone: '+998902221012', grp: class1A.id, balance: 0, fee: 3200000, paid: 3200000 },
  ];
  ...
  // School Leads
  const schoolLeads = [
    { name: 'Otabek Mirzayev (Farzandi 1-sinfga)', phone: '+998902222001', status: LeadStatus.NEW, source: 'Tavsiya' },
    { name: 'Nigora Rasulova (Farzandi 5-sinfga)', phone: '+998902222002', status: LeadStatus.CONTACTED, source: 'Instagram' },
    { name: 'Sanjar Saidov (Farzandi 1-sinfga)', phone: '+998902222003', status: LeadStatus.TRIAL_BOOKED, source: 'Banner' },
    { name: 'Munira Qosimova (Farzandi 9-sinfga)', phone: '+998902222004', status: LeadStatus.TRIAL_ATTENDED, source: 'Telegram' },
    { name: 'Farxod Alimov (Farzandi 2-sinfga)', phone: '+998902222005', status: LeadStatus.ENROLLED, source: 'Tavsiya' },
    { name: 'Zebo Normurodova', phone: '+998902222006', status: LeadStatus.LOST, source: 'Banner', notes: 'Maktab uzoqlik qildi' },
  ];
  ...
  const schExpenses = [
    { title: 'Maktab binosi saqlash va ta\'mirlash', amount: 25000000, payee: 'Toshkent Qurilish Servis' },
  ...
  const branchKinder = await prisma.branch.upsert({
    where: { organizationId_name: { organizationId: orgKinder.id, name: "Mirzo Ulug'bek Bosh Bog'cha" } },
    update: {},
    create: {
      organizationId: orgKinder.id,
  ...
  const rKnd1 = await prisma.room.create({
    data: { organizationId: orgKinder.id, branchId: branchKinder.id, name: 'Quyoshcha xonasi (Kichik)', capacity: 16 },
  });
  const rKnd2 = await prisma.room.create({
    data: { organizationId: orgKinder.id, branchId: branchKinder.id, name: 'Mittivoylar xonasi (O\'rta)', capacity: 18 },
  });
  ...
  const kinderStudentsData = [
    { firstName: 'Umarbek', lastName: 'Sharipov', phone: '+998903331001', grp: grpKichik.id, balance: 0, fee: 1900000, paid: 1900000 },
    { firstName: 'Muslima', lastName: 'Alimova', phone: '+998903331002', grp: grpKichik.id, balance: -1900000, fee: 1900000, paid: 0 },
    { firstName: 'Imronbek', lastName: 'Rasulov', phone: '+998903331003', grp: grpKichik.id, balance: 0, fee: 1900000, paid: 1900000 },
    { firstName: 'Rayyona', lastName: 'Sobirova', phone: '+998903331004', grp: grpMitti.id, balance: 0, fee: 1900000, paid: 1900000 },
    { firstName: 'Muhammad Ali', lastName: 'Toirov', phone: '+998903331005', grp: grpMitti.id, balance: -1900000, fee: 1900000, paid: 0 },
    { firstName: 'Fotima', lastName: 'Zokirova', phone: '+998903331006', grp: grpMitti.id, balance: 0, fee: 1900000, paid: 1900000 },
    { firstName: 'Zuhra', lastName: 'Zokirova', phone: '+998903331007', grp: grpMitti.id, balance: 0, fee: 1900000, paid: 1900000 },
    { firstName: 'Amirbek', lastName: 'Qodirov', phone: '+998903331008', grp: grpKichik.id, balance: -950000, fee: 1900000, paid: 950000 },
    { firstName: 'Soliha', lastName: 'Xoliqova', phone: '+998903331009', grp: grpMitti.id, balance: 0, fee: 1900000, paid: 1900000 },
    { firstName: 'Yahyobek', lastName: 'Normatov', phone: '+998903331010', grp: grpKichik.id, balance: 0, fee: 1900000, paid: 1900000 },
  ];
  ...
  // Bog'cha Leads
  const kinderLeads = [
    { name: 'Shahlo Karimova (Farzandi 2 yosh)', phone: '+998903332001', status: LeadStatus.NEW, source: 'Instagram' },
    { name: 'Nodir Ergashev (Farzandi 3 yosh)', phone: '+998903332002', status: LeadStatus.CONTACTED, source: 'Tavsiya' },
    { name: 'Gulzoda Aliyeva (Farzandi 4 yosh)', phone: '+998903332003', status: LeadStatus.TRIAL_BOOKED, source: 'Banner' },
    { name: 'Akbar Vohidov (Farzandi 3 yosh)', phone: '+998903332004', status: LeadStatus.TRIAL_ATTENDED, source: 'Instagram' },
    { name: 'Malika Rustamova', phone: '+998903332005', status: LeadStatus.ENROLLED, source: 'Telegram' },
  ];
  ...
  const kndExpenses = [
    { title: '4 mahal bolalar taomlari oziq-ovqati', amount: 9500000, payee: 'Sanoat Ta\'minot Food' },
  ...
  const branchServis = await prisma.branch.upsert({
    where: { organizationId_name: { organizationId: orgServis.id, name: 'Mirobod Servis Markazi' } },
    update: {},
    create: {
      organizationId: orgServis.id,
  ...
  const rSrv101 = await prisma.room.create({
    data: { organizationId: orgServis.id, branchId: branchServis.id, name: '101 - 1C Kompyuter zali', capacity: 20 },
  });
  const rSrv102 = await prisma.room.create({
    data: { organizationId: orgServis.id, branchId: branchServis.id, name: '102 - SMM Studiyasi', capacity: 18 },
  });
  ...
  const servisStudentsData = [
    { firstName: 'Sardorbek', lastName: 'Valiyev', phone: '+998904441001', grp: grp1C.id, balance: 0, fee: 1100000, paid: 1100000 },
    { firstName: 'Mohira', lastName: 'Umarova', phone: '+998904441002', grp: grp1C.id, balance: -1100000, fee: 1100000, paid: 0 },
    { firstName: 'Eldor', lastName: 'Nurmatov', phone: '+998904441003', grp: grp1C.id, balance: 0, fee: 1100000, paid: 1100000 },
    { firstName: 'Shahlo', lastName: 'Rustamova', phone: '+998904441004', grp: grp1C.id, balance: 0, fee: 1100000, paid: 1100000 },
    { firstName: 'Sanjar', lastName: 'Bekchanov', phone: '+998904441005', grp: grp1C.id, balance: -1100000, fee: 1100000, paid: 0 },
    { firstName: 'Nargiza', lastName: 'Tojiboyeva', phone: '+998904441006', grp: grpSmm.id, balance: 0, fee: 950000, paid: 950000 },
    { firstName: 'Nodirbek', lastName: 'Usmonov', phone: '+998904441007', grp: grpSmm.id, balance: -950000, fee: 950000, paid: 0 },
    { firstName: 'Malika', lastName: 'Shokirova', phone: '+998904441008', grp: grpSmm.id, balance: 0, fee: 950000, paid: 950000 },
  ];
  ...
  // Leads for Servis
  const srvLeads = [
    { name: 'Jamshid Ismoilov', phone: '+998904442001', status: LeadStatus.NEW, source: 'Instagram' },
    { name: 'Shahlo Qosimova', phone: '+998904442002', status: LeadStatus.CONTACTED, source: 'Telegram' },
    { name: 'Oybek Vohidov', phone: '+998904442003', status: LeadStatus.TRIAL_BOOKED, source: 'Tavsiya' },
    { name: 'Dilrabo Karimova', phone: '+998904442004', status: LeadStatus.TRIAL_ATTENDED, source: 'Instagram' },
    { name: 'Ulugbek Rahmonov', phone: '+998904442005', status: LeadStatus.ENROLLED, source: 'Banner' },
    { name: 'Nargiza Aliyeva', phone: '+998904442006', status: LeadStatus.LOST, source: 'Instagram' },
  ];
