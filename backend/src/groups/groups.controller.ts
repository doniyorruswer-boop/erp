...
export class GroupsController {
  ...
  transferStudent(
    ...
    return this.groupsService.transferStudent(sourceGroupId, targetGroupId, studentId, orgId, reason, req?.user?.id, branchCtx);
  }
  ...
  addStudent(
    ...
    return this.groupsService.addStudent(groupId, studentId, orgId, req.user?.id, reason, branchCtx);
  }
