...
export class NotificationsController {
  ...
  @Post('read-all')
  @RequirePermissions('notifications.view')
  markAllAsRead(@CurrentTenant() orgId: string, @Request() req: any) {
  ...
  @Put('templates/:id')
  @RequirePermissions('settings.manage')
  updateTemplate(@Param('id') id: string, @Body() body: UpdateNotificationTemplateDto, @CurrentTenant() orgId: string) {
