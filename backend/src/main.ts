...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle('EduCRM API')
    .setDescription('O‘zbekistondagi o‘quv markazlari va B2B korxonalar uchun Universal ERP API hujjatlari')
    .setVersion('2.0.0')
    .addBearerAuth()
    .build();
  ...
  console.log(`🚀 EduCRM Server ishga tushdi: http://localhost:${port}/api`);
